                                ...
                                <>
                                    {
                                        logo.map(c =>
                                            logo.map(c =>
                                                <Link className='btn btn-md  btn-gradient animation' to={`/edit-logo/${c._id}`}> Please Edit Your Logo</Link>)
                                ...
                                <form class="contact-form " onSubmit={handleLogo}>
                                    ...
                                    <div className="col-lg-12 col-md-12 mb-3">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-md  btn-gradient animation" data-animation="fadeInRight" data-delay=".8s">Update Your Logo</button>
                                        </div>
                                    </div>
