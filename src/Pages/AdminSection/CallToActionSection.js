                                    ...
                                    <>
                                        {
                                            ...
                                            action.map(c =>
                                                <Link className='btn btn-md  btn-gradient animation' to={`/edit-call/${c._id}`}> Edit Call To Action</Link>)
                                    ...
                                    <form class="contact-form " onSubmit={handleActionSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button class="btn btn-md  btn-gradient animation" data-animation="fadeInRight" data-delay=".8s">Add Call To Action</button>
                                            </div>
                                        </div>
