...
const Pricing = () => {
    ...
    return (
        ...
        <HeaderBottom></HeaderBottom>
            <div>
                <section id="services" class="services-area pt-100 pb-90 fix " >
                    <div class="container">
                        <div class="row">
                                ...
                                <form class="contact-form " onSubmit={handlePricing}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-md  btn-gradient animation" data-delay=".8s"> Add Package</button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="pricingTable">
                                        ...
                                        <div class="pricingTable-signup">
                                            <Link to={`/package-edit/${pri._id}`} className='btn btn-md  btn-gradient animation'>Edit Pricing</Link>
                                        </div>
                                    </div>
                                </div>
                            )}
