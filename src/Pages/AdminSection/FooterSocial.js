                                ...
                                <>
                                    {
                                        footersocial.map(c =>
                                            footersocial.map(c =>
                                                <Link className='btn btn-md  btn-gradient animation' to={`/edit-social-footer/${c._id}`}> Edit Social URL </Link>)
                            ...
                            }
                            {
                                ...
                                <form class="contact-form " onSubmit={handleFootersocial}>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="contact-field p-relative c-name mb-20">
                                                <input type="text" name="about" placeholder="About Details" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-md  btn-gradient animation" data-delay=".8s"> Add Footer Social </button>
                                        </div>
                                    </div>
