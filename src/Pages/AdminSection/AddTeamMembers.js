                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <h3 className='mt-5'> Update Team Members Text </h3>
                                {
                                    ...
                                    <>
                                        {teamtext.map(text =>
                                            <Link className='btn btn-md  btn-gradient animation' to={`/team-text-edit/${text._id}`}> Update Now</Link>
                                        )}
                                    </>
                                }
                                    ...
                                    <form class="contact-form " onSubmit={handleTeamTextSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button class="btn btn-md  btn-gradient animation" data-animation="fadeInRight" data-delay=".8s"> Add Team Members Text </button>
                                            </div>
                                        </div>
                                ...
                                <form class="contact-form " onSubmit={handleMembersItemSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-md  btn-gradient animation" data-delay=".8s"> Add Member Item</button>
                                        </div>
                                    </div>
                                ...
                                <div className="row slider-shadow th-carousel teamSlide1" id="teamSlide1" data-slide-show={4} data-lg-slide-show={3} data-md-slide-show={2} data-sm-slide-show={2} data-xs-slide-show={1} data-arrows="true">
                                    {
                                        teamitems.map(m => <div className="col-sm-6 col-lg-4 col-xxl-3">
                                            <div className="th-team team-box wow fadeInUp">
                                                ...
                                                <Link to={`/edit-team-items/${m._id}`}><h3 className="box-title" class="btn btn-md  btn-gradient animation">Edit Now</h3></Link>
