                                ...
                                <>
                                    {
                                        countersec.map(c =>
                                            countersec.map(c=>
                                                <Link className='btn btn-md  btn-gradient animation' to={`/counters/${c._id}`}> Update Counter</Link>)
                                        )
                                    }
                                </>
                            }
                                ...
                                <form class="contact-form " onSubmit={handleCounterSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn-md  btn-gradient animation" data-animation="fadeInRight" data-delay=".8s">Update Counter</button>
                                        </div>
                                    </div>
