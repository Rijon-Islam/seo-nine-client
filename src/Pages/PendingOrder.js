                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        {order.paymentStatus === 'UnPaid' && (
                                            <Link className='btn btn-md  btn-gradient animation' to={`/pay-now/${order._id}`}>Pay Now</Link>
                                        )}
                                        {order.paymentStatus === 'Paid' && (
                                            <Link className='btn btn-md  btn-gradient animation' to='#'>You Have Paid</Link>
                                        )}
                                    </td>
                                </tr>
                            ))}
